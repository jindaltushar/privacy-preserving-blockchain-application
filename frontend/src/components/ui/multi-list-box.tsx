...
interface ListboxTypes {
  ...
  selectedOptions: ListboxOption[]; // Change here
  children?: React.ReactNode;
  onChange: React.Dispatch<React.SetStateAction<ListboxOption[]>>; // Change here
...
export function Listbox({
  ...
  return (
    <div className={cn('relative', className)}>
      <HeadlessListbox
        value={selectedOptions} // Change here
        onChange={onChange} // Change here
        multiple={multiple}
      >
