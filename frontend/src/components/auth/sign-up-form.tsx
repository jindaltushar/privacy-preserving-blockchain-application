...
export default function SignUpForm() {
  ...
  function handleSubmit(e: any) {
    ...
    setFormData({
      ...
      lastName: stringToBytes32(String('')),
      bio: stringToBytes32(String('')),
      digest:
      ...
      profileAvatar: 0,
      twitter_handle: stringToBytes32(String('')),
      facebook_handle: stringToBytes32(String('')),
      instagram_handle: stringToBytes32(String('')),
      external_link: stringToBytes32(String('')),
    ...
    <form noValidate onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
      <div className="w-full">
        <Input
          name="firstName"
          type="text"
          placeholder="Choose a name for your account"
